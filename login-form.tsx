...
import { useRouter } from "next/navigation" // Endret fra next/router til next/navigation
...
export default function LoginForm() {
  ...
  const handleSignIn = (e: React.FormEvent) => {
    e.preventDefault()
    // Her ville du normalt håndtere autentisering
    // For nå, la oss bare navigere til forsiden
    router.push("/frontpage")
  }

  const handleFeideSignIn = () => {
    // Her ville du normalt håndtere Feide-autentisering
    // For nå, la oss bare navigere til forsiden
    router.push("/frontpage")
  }
